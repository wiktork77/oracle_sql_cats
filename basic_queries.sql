-- Na poczatku kazdej sesji - modyfikuje wyswietlana date! gwiazdka vs atrybut obowiazkowy - co jest efektywniejsze - normalnie gwiazdka, chyba ze indeks
-- Indeks zak³adamy zawsze na klucz g³ówny
...
--SELECT LPAD(' ', (LEVEL - 1)*4, ' ') || pseudo "Droga sluzbowa", CONNECT_BY_ROOT pseudo "root", SYS_CONNECT_BY_PATH(pseudo,'-') "sciezka"
--FROM kocury
--CONNECT BY PRIOR szef = pseudo 
--START WITH (MONTHS_BETWEEN(sysdate, w_stadku_od) / 12) > 14 AND plec = 'M' AND myszy_extra IS NULL;
